...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-tagsinput/0.8.0/bootstrap-tagsinput.css" crossorigin="anonymous">
    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
          ...
          <h6 class="card-body-title">New Product Add <a href="{{ route('all.product')}}" class="btn btn-info btn-sm pull-right">All Product</a></h6>
          ...
          <div class="form-layout">
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
                ...
                <label class="custom-file">
                <input type="file" id="file" class="custom-file-input" name="image_one_1" onchange="readURL1(this);" required="" accept="image">
                <span class="custom-file-control"></span>
                <img src="#" id="one_1" >
              </label>
              </div>
              ...
              <div class="col-lg-4">
                ...
                <label class="custom-file">
                <input type="file" id="file" class="custom-file-input" name="image_four" onchange="readURL4(this);" required="" accept="/image">
                <span class="custom-file-control"></span>
                <img src="#" id="four" >
              </label>
              </div>
            ...
            <div class="row">
            	<div class="col-lg-4">
            		<label class="ckbox">
					  <input type="checkbox" name="newarrivals_one" value="1">
					  <span>New Arrivals One</span>
					</label>
            	</div>
              <div class="col-lg-4">
                <label class="ckbox">
            <input type="checkbox" name="newarrivals_two" value="1">
            <span>New Arrivals Two</span>
          </label>
              </div>
              <div class="col-lg-4">
                <label class="ckbox">
            <input type="checkbox" name="newarrivals_three" value="1">
            <span>New Arrivals Three</span>
          </label>
              </div>
            	<div class="col-lg-4">
            		<label class="ckbox">
					  <input type="checkbox" name="newarrivals_four" value="1">
					  <span>New Arrivals Four</span>
					</label>
            	</div>
            	<div class="col-lg-4">
            		<label class="ckbox">
					  <input type="checkbox" name="newarrivals_five" value="1">
					  <span>New Arrivals Five</span>
					</label>
            	</div>
            	<div class="col-lg-4">
            		<label class="ckbox">
					  <input type="checkbox" name="latest_design" value="1">
