...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-tagsinput/0.8.0/bootstrap-tagsinput.css" crossorigin="anonymous">
    ...
    <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        ...
        <span class="breadcrumb-item active">Subcategorypage Section</span>
      </nav>
      <div class="sl-pagebody">
      	   <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">New Subcategorypages Add <a href="{{ route('all.subcategorypages')}}" class="btn btn-info btn-sm pull-right">All Subcategorypages</a></h6>
          <p class="mg-b-20 mg-sm-b-30">New subcategorypages add form</p>
          <form action="{{ route('store.subcategorypages') }}" method="post" enctype="multipart/form-data">
          	@csrf
            ...
            <div class="row mg-b-25">
              <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Title (only single image part)<span class="tx-danger">*</span></label>
