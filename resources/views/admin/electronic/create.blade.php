...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-tagsinput/0.8.0/bootstrap-tagsinput.css" crossorigin="anonymous">
    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
          ...
          <h6 class="card-body-title">New Electronic Add <a href="{{ route('all.electronics')}}" class="btn btn-info btn-sm pull-right">All Electronic</a></h6>
          <p class="mg-b-20 mg-sm-b-30">New Electronic add form</p>
          <form action="{{ route('store.electronics') }}" method="post" enctype="multipart/form-data">
          	@csrf
          ...
          <div class="form-layout">
            ...
            <div class="row">
            	<div class="col-lg-4">
            		<label class="ckbox">
					  <input type="checkbox" name="product_one" value="1">
					  <span>Product One</span>
					</label>
            	</div>
              <div class="col-lg-4">
                <label class="ckbox">
            <input type="checkbox" name="product_two" value="1">
            <span>Product Two</span>
          </label>
              </div>
              <div class="col-lg-4">
                <label class="ckbox">
            <input type="checkbox" name="product_three" value="1">
            <span>Product Three</span>
          </label>
              </div>
            	<div class="col-lg-4">
            		<label class="ckbox">
					  <input type="checkbox" name="product_four" value="1">
					  <span>Product Four</span>
					</label>
            	</div>
            	<div class="col-lg-4">
            		<label class="ckbox">
					  <input type="checkbox" name="latest_product" value="1">
