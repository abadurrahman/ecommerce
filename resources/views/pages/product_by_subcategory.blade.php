	...
	<div class="container">
			...
			<div class="community-poll">
				...
				<div class="swit form">	
                   @foreach($brands as $row)
				    ...
				    @endphp		   
					<div class="check_box"> <div class="radio"> <label><input type="radio" name="radio" checked="">{{$brand->brand_name}}</label> </div></div>
					@endforeach
				</div>
			</div>
							...
							<img src="{{asset($pro->image_one)}}" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="{{ url('product/details/'.$pro->id.'/'.$pro->product_name) }}" class="link-product-add-cart">Quick View</a>
											</div>
										</div>
		...
		<div class="single-pro">
			...
			<div class="col-md-3 product-men">
				<div class="men-pro-item simpleCart_shelfItem">
					<div class="men-thumb-item">
						<img src="{{asset($product->image_one)}}" alt="" class="pro-image-front">
						<img src="{{asset($product->image_one)}}" alt="" class="pro-image-back">
							<div class="men-cart-pro">
								<div class="inner-men-cart-pro">
